...
set output 'responseTimeLaw.eps'
...
#set xtics 0, 100000
plot "interactiveLawResultsWithRealThroughput.csv" using 1:2 title "Throughput Calculated Based on Response Time Law" with lines ls 1, "interactiveLawResultsWithRealThroughput.csv" using 1:3 title "Real Throughput of the System" with lines ls 2
