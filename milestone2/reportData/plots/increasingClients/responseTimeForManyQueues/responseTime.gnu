...
set xtics 0, 20
plot "responseTimeAllRequests.csv" using 1:2:3 title "Response time for LIST\\_QUEUES, SEND\\_MESSAGE, RECEIVE\\_MESSAGE" with errorlines ls 1, "responseTimeAllRequests.csv" using 1:5 title "Calculated Response time for LIST\\_QUEUES, SEND\\_MESSAGE, RECEIVE\\_MESSAGE" with errorlines ls 2
