...
public class ConnectionPool {
    ...
    private volatile int numberOfConnectionsCreated;
    private final int maximumConnections;

    public ConnectionPool(String host, int portNumber, String username, String password, String databaseName, int maximumConnections) {
        ...
        this.connections = new ArrayBlockingQueue<>(maximumConnections);
        this.host = host;
        this.portNumber = portNumber;
        this.username = username;
        this.password = password;
        this.databaseName = databaseName;
        this.numberOfConnectionsCreated = 0;
    ...
    public Connection getConnection() {
        if (numberOfConnectionsCreated < maximumConnections) {
            synchronized (this) {
                ...
                // verify the condition still holds, if not retry the function
                if (numberOfConnectionsCreated >= maximumConnections) {
                ...
                try {
                    Connection connection = createInitialConnection();
    ...
    public void close() {
        for (int i = 0; i < connections.size(); ++i) {
            ...
            try {
                ...
                // close actual internal connection
